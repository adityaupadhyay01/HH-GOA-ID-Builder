 ...
 *
 * Only the PUBLIC anon/publishable key belongs here. It is safe to ship
 * this key to the browser as long as Row Level Security (RLS) policies
 * are enabled on every table and storage bucket (see supabase-schema.sql).
 *
 * NEVER put a service_role / secret key in this file or anywhere in
 * frontend code.
 *
...
window.SUPABASE_CONFIG = {
  ...
  SUPABASE_ANON_KEY: "YOUR_SUPABASE_ANON_KEY", // sb_publishable_...
